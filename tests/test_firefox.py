...
"""
        ...
        with patch('os.path.exists', return_value=True), \
             ...
             patch('configparser.ConfigParser.sections', return_value=["Profile0", "Profile1"]):
            ...
            with patch('configparser.ConfigParser.__getitem__', side_effect=mock_getitem):
...
"""
        ...
        with patch('os.path.exists', return_value=True), \
            ...
            def mock_getitem(section_name):
                if section_name == "Profile0":
                    ...
                    section_mock.getboolean = lambda key, default=False: key == "Default"
                    section_mock.get = lambda key, default=None: section.get(key, default)
                    return section_mock
                elif section_name == "Profile1":
                    section = {"Name": "work"}
                    section_mock = type('MockSection', (), section)()
    ...
    def test_get_private_mode_icon(self):
        ...
        with patch.object(firefox, 'get_browser_icon', return_value="/path/to/icon.png"):
    ...
    def test_get_profile_icon_private(self):
        ...
        firefox = FirefoxBrowser()
        private_profile = Profile("private", "Private Window", "firefox", is_private=True)
