...
<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Field lines -->
  <rect x="8" y="8" width="48" height="48" rx="4" fill="none" stroke="#81C784" stroke-width="1"/>
  <line x1="32" y1="8" x2="32" y2="56" stroke="#81C784" stroke-width="1"/>
  <circle cx="32" cy="32" r="8" fill="none" stroke="#81C784" stroke-width="1"/>
  
  <!-- Goal posts -->
  <rect x="28" y="6" width="8" height="4" fill="#FFC107"/>
  <rect x="28" y="54" width="8" height="4" fill="#FFC107"/>
  
  <!-- Football -->
  <ellipse cx="32" cy="32" rx="8" ry="6" fill="white"/>
  <ellipse cx="32" cy="32" rx="8" ry="6" fill="none" stroke="#2E7D32" stroke-width="1"/>
  <line x1="26" y1="32" x2="38" y2="32" stroke="#2E7D32" stroke-width="1"/>
  <line x1="29" y1="28" x2="35" y2="28" stroke="#2E7D32" stroke-width="0.8"/>
  <line x1="29" y1="36" x2="35" y2="36" stroke="#2E7D32" stroke-width="0.8"/>
  
  <!-- Browser icons as small circles -->
  <circle cx="20" cy="20" r="4" fill="#4285F4" opacity="0.8"/>
  <circle cx="44" cy="20" r="4" fill="#FF9800" opacity="0.8"/>
  <circle cx="20" cy="44" r="4" fill="#E53E3E" opacity="0.8"/>
  <circle cx="44" cy="44" r="4" fill="#9C27B0" opacity="0.8"/>
</svg>
EOF
